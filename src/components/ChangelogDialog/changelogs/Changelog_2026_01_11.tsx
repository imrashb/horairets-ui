  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          ✅ Sélectionnez votre horaire actuel pour chaque session afin de les retrouver facilement
        </li>
      </ul>
      ...
      <ul>
        <li>
          🕒 Nouveau filtre de disponibilités pour filtrer les horaires selon vos plages libres
        </li>
